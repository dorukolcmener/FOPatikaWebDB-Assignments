...
# C# Phone Book - Project #1

Assignment Link: [Patika.Dev C# Project #1](https://app.patika.dev/courses/csharp-101/19-proje-1), My Patika Profile Link: [Kaolin](https://app.patika.dev/kaolin)

## ❓Phone Book Project #1 :

In a console application, write a phone book application with following features:

- Save contact
- Remove contact
- Edit phone number of a contact
- List all contacts (A-Z,Z-A)
- Search contact

## ✏️Answer 1 :

To view the full source code files please reference to current directory. You can find everything here.

## ❗Important Note:

I haved utilized static list inside the class that stores every created **Contact** object automatically. Ref to Contact class to view the Static constructor and the static List\<Contact\> that stores/adds them inside the default constructor scope.
